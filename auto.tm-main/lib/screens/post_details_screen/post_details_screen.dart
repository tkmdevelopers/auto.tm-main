                            ...
                            children: [
                              Container(
                                ...
                                child: CarouselSlider.builder(
                                  ...
                                  itemBuilder: (context, index, realIndex) {
                                    final photo =
                                        post.value!.photoPaths[realIndex];
                                    ...
                                    child: Container(
                                      ...
                                      child: Obx(() {
                                        final photos = detailsController
                                            ...
                                            ?.photoPaths;
                                        final currentPage =
                                            detailsController.currentPage.value;
                              ...
                              Obx(() {
                                ...
                                final bool hasVideo =
                                    ...
                                    detailsController.post.value!.video !=
                                        null &&
                                    detailsController
                                        .post
                                        .value!
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: AppStyles.f24w7Th(context)
                                          .copyWith(
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: AppStyles.f12w4Th(
                                        context,
                                      ).copyWith(color: Color(0xFF403A3A)),
                                    ),
                                  ),
                                ],
                              ),
...
class _DynamicCharacteristics extends StatelessWidget {
      ...
      rows.add(
        Row(
          ...
          children: [
            ...
            Expanded(
              child: second != null
                  ? _buildCharacteristicsItem(context, second)
                  : const SizedBox(),
            ),
          ],
        ),
  ...
  Widget _buildCharacteristicsItem(
    BuildContext context,
    _CharacteristicEntry e,
  ) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
