...
class NotificationService extends GetxService {
  ...
  Future<void> _initializeLocalNotifications() async {
    ...
    // Try custom monochrome status-bar icon first (place PNG vectorized white silhouette
    // at android/app/src/main/res/drawable/ic_stat_notify.png). Falls back to 'ic_launcher'
    // if not found to avoid invalid_icon crashes.
  ...
  void _showNotification(RemoteMessage message) async {
    ...
    const androidDetails = AndroidNotificationDetails(
      ...
      channelDescription: 'App updates and general alerts',
      importance: Importance.max,
      priority: Priority.high,
      // Ensure status bar icon uses custom monochrome resource (will fallback automatically if missing).
      icon: 'ic_stat_notify',
    );
