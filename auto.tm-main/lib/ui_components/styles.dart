...
class AppStyles {
  ...
  static TextStyle f10w4Th(BuildContext context) => base.copyWith(
    fontSize: 10,
    color: Theme.of(context).colorScheme.onSurface.opacityCompat(0.6),
    fontWeight: FontWeight.w400,
  );
  ...
  static TextStyle f18w4Th(BuildContext context) => base.copyWith(
    fontSize: 18,
    fontWeight: FontWeight.w400,
    color: Theme.of(context).colorScheme.onSurface.opacityCompat(0.7),
  );
  ...
  static PinTheme defaultPinTheme(BuildContext context) {
    ...
    return PinTheme(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: theme.colorScheme.outlineVariant.opacityCompat(0.5),
        ),
        boxShadow: [
          BoxShadow(
  ...
  static PinTheme submittedPinTheme(BuildContext context) {
    ...
    return defaultPinTheme(context).copyWith(
      decoration: defaultPinTheme(context).decoration?.copyWith(
        color: theme.colorScheme.surfaceContainerHighest.opacityCompat(0.5),
      ),
    );
  }
  ...
  static PinTheme errorPinTheme(BuildContext context) {
    ...
    return defaultPinTheme(context).copyWith(
      decoration: BoxDecoration(
        color: theme.colorScheme.errorContainer.opacityCompat(0.2),
        borderRadius: BorderRadius.circular(16),
