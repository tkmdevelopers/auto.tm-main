import 'package:auto_tm/data/repositories/search_repository_impl.dart';
...
import 'package:auto_tm/data/repositories/subscription_repository_impl.dart';
import 'package:auto_tm/domain/repositories/subscription_repository.dart';
import 'package:auto_tm/data/repositories/auth_repository_impl.dart';
import 'package:auto_tm/data/repositories/brand_repository_impl.dart';
import 'package:auto_tm/data/repositories/common_repository_impl.dart';
import 'package:auto_tm/data/repositories/favorite_repository_impl.dart';
import 'package:auto_tm/data/repositories/filter_repository_impl.dart';
...
void main() async {
  ...
  try {
    ...
    try {
      ...
      // #region agent log
      _logDebug('main.dart:42', 'GetStorage.init() failed', {
        'error': e.toString(),
      }, hypothesisId: 'A');
      // #endregion
      rethrow;
    ...
    try {
      ...
      // #region agent log
      _logDebug('main.dart:50', 'Firebase.initializeApp() failed', {
        'error': e.toString(),
    ...
    _logDebug(
      'main.dart:91',
      'FlutterDownloader will be lazy-initialized when needed',
      {},
      hypothesisId: 'A',
    );
    // #endregion
    ...
    try {
      ...
      // #region agent log
      _logDebug('main.dart:112', 'dotenv.load() completed', {
        'apiBase': dotenv.env['API_BASE'] ?? 'not found',
      }, hypothesisId: 'A');
      // #endregion
    } catch (e, stackTrace) {
      // #region agent log
      _logDebug('main.dart:116', 'dotenv.load() failed (non-fatal)', {
        'error': e.toString(),
        'errorType': e.runtimeType.toString(),
    ...
    try {
      ...
      // #region agent log
      _logDebug('main.dart:135', 'initServices() failed', {
        'error': e.toString(),
        'errorType': e.runtimeType.toString(),
        'stackTrace': stackTrace.toString(),
      }, hypothesisId: 'B');
    ...
    try {
      ...
      _logDebug(
        'main.dart:147',
        'SystemChrome.setPreferredOrientations() completed',
        {},
        hypothesisId: 'A',
      );
      // #endregion
      ...
      _logDebug(
        'main.dart:151',
        'SystemChrome.setPreferredOrientations() failed',
        {'error': e.toString()},
        hypothesisId: 'A',
      );
      // #endregion
    ...
    try {
      ...
      // #region agent log
      _logDebug('main.dart:165', 'Permission.request() failed', {
        'error': e.toString(),
      }, hypothesisId: 'A');
      // #endregion
    }
    ...
    try {
      ...
      // #region agent log
      _logDebug('main.dart:181', 'runApp() failed', {
        'error': e.toString(),
        'errorType': e.runtimeType.toString(),
        'stackTrace': stackTrace.toString(),
      }, hypothesisId: 'G');
    ...
    // #region agent log
    _logDebug('main.dart:187', 'main() top-level exception caught', {
      'error': e.toString(),
      'errorType': e.runtimeType.toString(),
      'stackTrace': stackTrace.toString(),
    }, hypothesisId: 'A');
...
Future<void> initServices() async {
  try {
    ...
    // #region agent log
    _logDebug(
      'main.dart:initServices:76',
      'ThemeController registered',
      {},
      hypothesisId: 'B',
    );
    // #endregion
    ...
    // #region agent log
    _logDebug(
      'main.dart:initServices:79',
      'ThemeController registration failed',
      {'error': e.toString()},
      hypothesisId: 'B',
    );
    // #endregion
  ...
  try {
    ...
    // #region agent log
    _logDebug(
      'main.dart:initServices:85',
      'ConnectionController registered',
      {},
      hypothesisId: 'B',
    );
    // #endregion
    ...
    // #region agent log
    _logDebug(
      'main.dart:initServices:88',
      'ConnectionController registration failed',
      {'error': e.toString()},
      hypothesisId: 'B',
    );
    // #endregion
  ...
  try {
    ...
    Get.put<LocalStorage>(GetStorageImpl(), permanent: true);
    // #region agent log
    _logDebug(
      'main.dart:initServices:94',
      'DownloadController registered',
      {},
      hypothesisId: 'B',
    );
    // #endregion
    ...
    // #region agent log
    _logDebug(
      'main.dart:initServices:97',
      'DownloadController registration failed',
      {'error': e.toString()},
      hypothesisId: 'B',
    );
    // #endregion
  ...
  // Register Persistence early
  Get.put(UploadPersistenceService());
  ...
  if (!Get.isRegistered<UploadManager>()) {
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:105',
        'UploadManager.init() completed',
        {},
        hypothesisId: 'C',
      );
      // #endregion
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:108',
        'UploadManager.init() failed',
        {
          'error': e.toString(),
          'errorType': e.runtimeType.toString(),
          'stackTrace': stackTrace.toString(),
  ...
  if (!Get.isRegistered<PostController>()) {
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:117',
        'PostController lazyPut completed',
        {},
        hypothesisId: 'B',
      );
      // #endregion
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:120',
        'PostController lazyPut failed',
        {'error': e.toString()},
        hypothesisId: 'B',
      );
      // #endregion
  ...
  // Register ApiClient (Dio + auth interceptor). Must come before AuthService and Repositories.
  if (!Get.isRegistered<ApiClient>()) {
    await Get.putAsync(() async => await ApiClient().init());
  }

  // Register Repositories - using Get.find inside closure to ensure lazy resolution works correctly
  Get.lazyPut<AuthRepository>(
    () => AuthRepositoryImpl(Get.find<ApiClient>(), storage: Get.find<LocalStorage>()),
    fenix: true,
  );
  Get.lazyPut<PostRepository>(
    () => PostRepositoryImpl(Get.find<ApiClient>()),
    fenix: true,
  );
  Get.lazyPut<BrandRepository>(
    () => BrandRepositoryImpl(Get.find<ApiClient>(), storage: Get.find<LocalStorage>()),
    fenix: true,
  );
  Get.lazyPut<FilterRepository>(
    () => FilterRepositoryImpl(Get.find<ApiClient>()),
    fenix: true,
  );
  Get.lazyPut<FavoriteRepository>(
    () => FavoriteRepositoryImpl(Get.find<ApiClient>()),
    fenix: true,
  );

  // Register FavoritesController globally so PostItem can access it anywhere
  ...
  Get.lazyPut<CommonRepository>(
    () => CommonRepositoryImpl(Get.find<ApiClient>()),
    fenix: true,
  );
  Get.lazyPut<SubscriptionRepository>(
    () => SubscriptionRepositoryImpl(Get.find<ApiClient>()),
    fenix: true,
  );
  Get.lazyPut<SearchRepository>(
    () => SearchRepositoryImpl(Get.find<ApiClient>()),
    fenix: true,
  );

  // Register AuthService (phone OTP + session). Must come after Repositories.
  if (!Get.isRegistered<AuthService>()) {
    try {
      Get.put(AuthService()); // AuthService uses default constructor
      // #region agent log
      _logDebug(
        'main.dart:initServices:129',
  ...
  if (!Get.isRegistered<ProfileController>()) {
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:151',
        'ProfileController registered',
        {},
        hypothesisId: 'F',
      );
      // #endregion
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:154',
        'ProfileController registration failed',
        {
          'error': e.toString(),
          'errorType': e.runtimeType.toString(),
          'stackTrace': stackTrace.toString(),
  ...
  if (!Get.isRegistered<FilterController>()) {
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:163',
        'FilterController registered',
        {},
        hypothesisId: 'F',
      );
      // #endregion
      ...
      // #region agent log
      _logDebug(
        'main.dart:initServices:166',
        'FilterController registration failed',
        {
          'error': e.toString(),
          'errorType': e.runtimeType.toString(),
          'stackTrace': stackTrace.toString(),
  ...
  if (!Get.isRegistered<HomeController>()) {
    try {
      ...
      _logDebug(
        ...
        'HomeController registration failed',
...
class AlphaMotorsApp extends StatelessWidget {
  AlphaMotorsApp({super.key}) {
    // #region agent log
    _logDebug(
      'main.dart:AlphaMotorsApp:216',
      'AlphaMotorsApp constructor started',
      {},
      hypothesisId: 'G',
    );
    // #endregion
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:AlphaMotorsApp:223',
        'ThemeController Get.find() failed',
        {'error': e.toString()},
        hypothesisId: 'G',
      );
      // #endregion
    ...
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:AlphaMotorsApp:232',
        'NotificationService Get.find() failed',
        {'error': e.toString()},
        hypothesisId: 'G',
      );
      // #endregion
    ...
    // #region agent log
    _logDebug(
      'main.dart:AlphaMotorsApp:237',
      'AlphaMotorsApp constructor completed',
      {},
      hypothesisId: 'G',
    );
    // #endregion
  ...
  Widget build(BuildContext context) {
    // #region agent log
    _logDebug(
      'main.dart:AlphaMotorsApp:build:246',
      'AlphaMotorsApp build() started',
      {},
      hypothesisId: 'G',
    );
    // #endregion
    try {
      ...
      // #region agent log
      _logDebug(
        'main.dart:AlphaMotorsApp:build:252',
        'Read isSubscribedToGlobalTopic',
      ...
      if (!isAlreadySubscribed) {
        try {
          ...
          // #region agent log
          _logDebug(
            'main.dart:AlphaMotorsApp:build:257',
            'subscribeToGlobalTopic() called',
            {},
            hypothesisId: 'G',
          );
          // #endregion
          ...
          // #region agent log
          _logDebug(
            'main.dart:AlphaMotorsApp:build:260',
            'subscribeToGlobalTopic() failed',
            {'error': e.toString()},
            hypothesisId: 'G',
          );
          // #endregion
      ...
      // #region agent log
      _logDebug('main.dart:AlphaMotorsApp:build:269', 'Locale set', {
      ...
      return Obx(() {
        try {
          ...
          // #region agent log
          _logDebug(
            'main.dart:AlphaMotorsApp:build:Obx:382',
            'Obx() callback started',
          ...
          // #region agent log
          _logDebug(
            'main.dart:AlphaMotorsApp:build:Obx:402',
            'About to return GetMaterialApp',
            {},
            hypothesisId: 'G',
          );
          // #endregion
          ...
          // #region agent log
          _logDebug(
            'main.dart:AlphaMotorsApp:build:Obx:428',
            'Obx() callback failed',
            {
              'error': e.toString(),
              'errorType': e.runtimeType.toString(),
      ...
      // #region agent log
      _logDebug('main.dart:AlphaMotorsApp:build:434', 'build() failed', {
        'error': e.toString(),
        'errorType': e.runtimeType.toString(),
        'stackTrace': stackTrace.toString(),
      }, hypothesisId: 'G');
